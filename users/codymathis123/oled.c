...
void layer_status(void) {
  ...
  if (layer_state_is(NAVR))
    oled_write_P(PSTR(">nav"), false);
  else if (layer_state_is(MOUR))
    oled_write_P(PSTR(">mse"), false);
  else if (layer_state_is(MEDR))
    oled_write_P(PSTR(">med"), false);
else if (layer_state_is(FUNL))
    oled_write_P(PSTR(">fun"), false);
else if (layer_state_is(NSL))
    oled_write_P(PSTR(">num"), false);
else if (layer_state_is(NSSL))
